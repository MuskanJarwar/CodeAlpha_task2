...
public class Question7 extends JFrame implements ActionListener {
    ...
    Question7(int count){
        ...
        add(image1);
        JLabel heading1=new JLabel("Question 7 ");
        heading1.setBounds(650,80,200,45);
        heading1.setFont(new Font("Mongolian Biati",Font.BOLD,34));
        heading1.setForeground(Color.black);
        add(heading1);
        JLabel question7=new JLabel("In Java, what is the purpose of the \"try\" block in exception handling?");
        question7.setBounds(460,150,700,25);
        question7.setFont(new Font("Mongolian Biati",Font.BOLD,16));
        question7.setForeground(Color.black);
        add(question7);
        opt1=new JRadioButton("A. Handle");
        ...
        add(opt1);
        opt2=new JRadioButton("B. Attempt");
        ...
        add(opt3);
        opt4=new JRadioButton("D. Finally");
