...
public class Question9 extends JFrame implements ActionListener {
    ...
    Question9(int count){
        ...
        add(image1);
        JLabel heading1=new JLabel("Question 9 ");
        heading1.setBounds(650,80,200,45);
        heading1.setFont(new Font("Mongolian Biati",Font.BOLD,34));
        heading1.setForeground(Color.black);
        add(heading1);
        JLabel question9=new JLabel(". What does the \"static\" keyword indicate in Java?");
        question9.setBounds(460,150,700,25);
        question9.setFont(new Font("Mongolian Biati",Font.BOLD,16));
        question9.setForeground(Color.black);
        add(question9);
        opt1=new JRadioButton("A. Constant");
        ...
        add(opt2);
        opt3=new JRadioButton("C.Shared");
        ...
        add(opt3);
        opt4=new JRadioButton("D.Dynamic");
        opt4.setBounds(750,300,110,25);
